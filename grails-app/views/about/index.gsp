    ...
    <main class="main">
        <div class="container">
            <section class="main-content content-page">
                ...
                <table>
                    <tr>
                        <td><img src="${createLinkTo(dir:'images',file:'cc-LGPL-a.png')}" alt="GNU LGPL" style="float:right;width:62px"/></td>
                        <td><img src="${createLinkTo(dir:'images',file:'cc-by-sa.png')}" alt="Creative Commons BY-SA Logo" style="margin-left: 15px;width:120px;"/></td>
                    </tr>
                </table>
