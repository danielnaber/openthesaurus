...
<html>
    ...
    <body>
        ...
        <div class="body">
            ...
            <h1><g:message code="user.lost.password.headline"/></h1>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
					                <div class="buttons">
					                    <span class="button"><input class="login" type="submit" value="${message(code:'user.lost.password.form.submit')}"></input></span>
					                </div>
                                </td>
                            </tr> 
