...
<g:form name="searchform" class="mainpage" action="search" controller="synset" method="get">
    ...
    <br />
    <!-- TODO: change again when fulltext search works:
    <g:managedCheckBox id="dbSearch" checked="${true}" name="dbSearch"
        disabled="${true}" value="${true}" /> <label for="dbSearch">Database Search (use % as wildcard)</label>
    <br/>
    -->
    <br/>
