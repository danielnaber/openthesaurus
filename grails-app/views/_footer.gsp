  ...
  <div class="footerColumn" style="margin-top: 44px; margin-right: 37px;">
      ...
      <div>
                  ...
                  <tr>
                      <td>
                          <script type="text/javascript">
                              ...
                              document.write("<a href='mail" + "to:" + firstPart + "@" + lastPart + "'><img class=\"socialMediaIcon\" src=\"${createLinkTo(dir:'images',file:'icon-mail.png')}?v2\" width=\"36\" height=\"36\" alt=\"Contact-Icon\"/><" + "/a>");
                              // -->
                          </script>
                      </td>
                      <td>&nbsp;</td>
          ...
          <div class="iconLink">
              <table>
                  <tr>
                      <td><a href="http://twitter.com/openthesaurus"><img class="socialMediaIcon" src="${createLinkTo(dir:'images',file:'icon-twitter.png')}?v2" width="36" height="36" alt="Twitter-Icon"/></a></td>
                      <td>&nbsp;</td>
          ...
          <div class="iconLink">
              <table>
                  <tr>
                      <td><a href="https://github.com/danielnaber/openthesaurus"><img class="socialMediaIcon" src="${createLinkTo(dir:'images',file:'icon-github.png')}?v2" width="36" height="36" alt="Github-Icon"/></a></td>
                      <td>&nbsp;</td>
